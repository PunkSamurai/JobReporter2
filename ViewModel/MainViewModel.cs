    ...
    public class MainViewModel : ObservableObject
    {
        ...
        public JobModel SelectedJob
        {
            ...
            set
            {
                ...
                {
                    // Generate pie chart after job is selected and data is loaded
                    _selectedJob?.GeneratePieChart();
                }
            }
        }
        ...
        public MainViewModel()
        {
            ...
            {
                new ShiftModel {  Name = "Shift 1", StartTime = TimeSpan.Zero, EndTime = TimeSpan.FromHours(23).Add(TimeSpan.FromMinutes(59)), IsEnabled = true }
            };
